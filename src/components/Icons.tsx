...
export const SupportIcon = (p: IconProps) => (
  <svg {...base} {...p}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 1 0-18 0v5.25A2.25 2.25 0 0 0 5.25 19.5h.75a.75.75 0 0 0 .75-.75v-4.5a.75.75 0 0 0-.75-.75H4.5m15 0h-1.5a.75.75 0 0 0-.75.75v4.5c0 .414.336.75.75.75H18A2.25 2.25 0 0 0 20.25 18" />
  </svg>
);
...
/** Brand glyph for WhatsApp (filled). */
